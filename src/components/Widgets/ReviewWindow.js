...
const StarRating = (props) => {
    ...
    return (
        <div className={classes.root}>
            ...
            {props.rate !== null && (
                <Box ml={2}>
                    {labels[props.hover !== -1 ? props.hover : props.rate]}
                </Box>
            )}
        </div>
    );
...
const ReviewWindow = (props) => {
    ...
    return (
        <div className="pop-up-window-background">
            <OutsideClickHandler
                onOutsideClick={() => props.setShowPopUp(false)}
            >
                <div id="review-pop-up-window">
                    ...
                    <section>
                        ...
                        <DollarRating
                            dollar={dollar}
                            setDollar={setDollar}
                            hoverDollar={hoverDollar}
                            setHoverDollar={setHoverDollar}
                        />
                    </section>
